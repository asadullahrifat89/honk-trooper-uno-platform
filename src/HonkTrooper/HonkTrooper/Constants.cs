...
namespace HonkTrooper
{
    static class Constants
    {
        ...
        public static (ConstructType ConstructType, Uri Uri)[] CONSTRUCT_TEMPLATES = new (ConstructType, Uri)[]
        {
            ...
            new (ConstructType.ROAD_SIDE_LIGHT_BILLBOARD, new Uri("ms-appx:///HonkTrooper/Assets/Images/road_side_light_billboard_1.png")),
            new (ConstructType.ROAD_SIDE_LIGHT_BILLBOARD, new Uri("ms-appx:///HonkTrooper/Assets/Images/road_side_light_billboard_2.png")),
            ...
            new (ConstructType.VEHICLE_BOSS_ROCKET, new Uri("ms-appx:///HonkTrooper/Assets/Images/vehicle_boss_rocket.png")),
            ...
            new (ConstructType.UFO_BOSS_ROCKET, new Uri("ms-appx:///HonkTrooper/Assets/Images/ufo_boss_rocket_1.png")),
            new (ConstructType.UFO_BOSS_ROCKET, new Uri("ms-appx:///HonkTrooper/Assets/Images/ufo_boss_rocket_2.png")),
            new (ConstructType.UFO_BOSS_ROCKET, new Uri("ms-appx:///HonkTrooper/Assets/Images/ufo_boss_rocket_3.png")),
        ...
        public static (SoundType SoundType, Uri Uri)[] SOUND_TEMPLATES = new (SoundType, Uri)[]
        {
            ...
            new (SoundType.TRASH_CAN_HIT, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/trashcan_hit_5.mp3")),
            ...
            new (SoundType.HONK, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/car_honk_1.mp3")),
            new (SoundType.HONK, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/car_honk_2.mp3")),
            new (SoundType.HONK, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/car_honk_3.mp3")),

            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_1.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_2.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_3.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_4.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_5.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_6.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_7.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_8.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_9.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_10.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_11.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_12.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_13.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_14.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_15.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_16.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_17.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_18.mp3")),
            new (SoundType.HONK_BUST_REACTION, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/honk_bust_reaction_19.mp3")),
            ...
            new (SoundType.UFO_HOVERING, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/ufo_boss_hovering_1.mp3")),
            new (SoundType.UFO_HOVERING, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/ufo_boss_hovering_2.mp3")),
            new (SoundType.UFO_HOVERING, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/ufo_boss_hovering_3.mp3")),

            new (SoundType.UFO_BOSS_ENTRY, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/ufo_boss_entry_1.mp3")),
            new (SoundType.UFO_BOSS_ENTRY, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/ufo_boss_entry_2.mp3")),

            new (SoundType.UFO_BOSS_DEAD, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/ufo_boss_dead_1.mp3")),
            new (SoundType.UFO_BOSS_DEAD, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/ufo_boss_dead_2.mp3")),
            ...
            new (SoundType.UFO_ENEMY_ENTRY, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/ufo_enemy_entry_1.mp3")),
            new (SoundType.UFO_ENEMY_ENTRY, new Uri("ms-appx:///HonkTrooper/Assets/Sounds/ufo_enemy_entry_2.mp3")),
