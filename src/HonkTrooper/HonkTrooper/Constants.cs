...
namespace HonkTrooper
{
    static class Constants
    {
        ...
        public static (ConstructType ConstructType, double Width, double Height)[] CONSTRUCT_SIZES = new (ConstructType, double, double)[]
        {
            ...
            new (ConstructType.ROAD_SIDE_BILLBOARD, 310, 310),
        ...
        public static (ConstructType ConstructType, Uri Uri)[] CONSTRUCT_TEMPLATES = new (ConstructType, Uri)[]
        {
            ...
            new (ConstructType.ROAD_SIDE_WALK, new Uri("ms-appx:///HonkTrooper/Assets/Images/side_walk_1.png")),
            //new (ConstructType.ROAD_SIDE_WALK, new Uri("ms-appx:///HonkTrooper/Assets/Images/side_walk_2.png")),
